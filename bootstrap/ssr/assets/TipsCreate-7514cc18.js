...
function TipsCreate({ closeModal }) {
  ...
  const submit = (e) => {
    ...
    post(route("tips.store"), {
      onSuccess: () => {
        toast.success("Tips Has Been Created!");
        closeModal();
      }
    });
  };
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs(
      "form",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: "flex justify-center items-center text-lg font-bold", children: /* @__PURE__ */ jsx("p", { children: "Tambah Tips" }) }),

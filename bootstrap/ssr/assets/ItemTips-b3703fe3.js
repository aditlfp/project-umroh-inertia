...
import TipsEdit from "./TipsEdit-a1786434.js";
import { toast } from "react-toastify";
function ItemTips({ datas }) {
  ...
  const handleDeleted = async (e) => {
    e.preventDefault();
    try {
      router.delete(`tips/${dataDelete.id}`);
      toast.warn("Done");
      setShowDel(!showDel);
    } catch (error) {
      ...
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            ref: modalDel,
            children: [
              /* @__PURE__ */ jsx("p", { children: "Yakin ingin menghapus Tips ini?" }),

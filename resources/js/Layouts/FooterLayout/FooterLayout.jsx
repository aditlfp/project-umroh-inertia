    ...
    return (
        <>
            ...
            <footer className="flex mt-20">
                <div id="title" className="flex flex-col ml-16 my-10">
                    <span
                        onClick={titleLink}
                        className="hover:cursor-pointer font-semibold text-indigo-950 text-5xl mb-10"
                ...
                <div id="link" className="my-10 flex">
                    {/* Comapny */}
                    <div id="company" className="ml-24">
                        <span
                            className="text-zinc-950 text-lg font-bold leading-relaxed"
                            style={{ fontFamily: "Poppins, sans-serif" }}
                        >
                            Company
                        </span>
                        <div
                            className="flex flex-col items-center mt-10 gap-y-4 text-gray-500 text-md font-bold"
                            style={{ fontFamily: "Poppins, sans-serif" }}
                        >
                            <span>Profile</span>
                            <span>Informasi</span>
